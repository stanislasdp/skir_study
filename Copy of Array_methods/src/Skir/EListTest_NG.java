...
//		del pos
		...
		@Test 
		public void DelPos_7()
		{
			int[] init_1 = {47,59,5,0,55,48,68};
			list.init(init_1);
			list.Delpos(4);
			assertEquals(6,list.size());
			int [] exp = {47,59,5,0,48,68};
			int [] act = list.ToArray();
			assertArrayEquals(exp,act);
...
//		set pos
		...
		@Test 
		public void testSetPos_7() {
			int[] init_1 = {47,59,5,0,55,48,68};
			list.init(init_1);
			list.SetPos(6, 99);
			assertEquals(7,list.size());
			int [] exp = {47,59,5,0,55,48,99};
			int [] act = list.ToArray();
			assertArrayEquals(exp,act);
		}
